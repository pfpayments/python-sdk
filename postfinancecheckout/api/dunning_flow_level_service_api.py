...
class DunningFlowLevelServiceApi:
    ...
    def read_with_http_info(self, space_id, id, **kwargs):
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='DunningFlowLevel',
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def search(self, space_id, query, **kwargs):
        ...
        :param async_req bool
        :param int space_id:  (required)
        :param EntityQuery query: Query restricting the returned dunning flow levels. (required)
    ...
    def search_with_http_info(self, space_id, query, **kwargs):
        ...
        return self.api_client.call_api(
            '/dunning-flow-level/search', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='list[DunningFlowLevel]',
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
