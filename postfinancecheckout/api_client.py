...
from postfinancecheckout.api_response import ApiResponse, T as ApiResponseT
import postfinancecheckout.models
from postfinancecheckout import rest
from postfinancecheckout.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(postfinancecheckout.models, klass)
