...
class AbstractCustomerAddressActive(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AbstractCustomerAddressActive from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AbstractCustomerAddressActive from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "address": CustomerPostalAddressCreate.from_dict(obj["address"]) if obj.get("address") is not None else None,
