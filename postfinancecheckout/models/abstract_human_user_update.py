...
class AbstractHumanUserUpdate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["mobilePhoneNumber", "twoFactorEnabled", "emailAddress", "firstname", "timeZone", "language", "state", "lastname"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AbstractHumanUserUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AbstractHumanUserUpdate from a dict"""
        if obj is None:
            return None
