...
class AbstractRoleUpdate(BaseModel):
    """
    AbstractRoleUpdate
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["permissions", "name", "twoFactorRequired"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AbstractRoleUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AbstractRoleUpdate from a dict"""
        if obj is None:
            return None
