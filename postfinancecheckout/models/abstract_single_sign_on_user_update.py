...
class AbstractSingleSignOnUserUpdate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["firstname", "timeZone", "language", "state", "lastname"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AbstractSingleSignOnUserUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AbstractSingleSignOnUserUpdate from a dict"""
        if obj is None:
            return None
