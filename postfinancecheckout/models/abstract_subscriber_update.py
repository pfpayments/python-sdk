...
class AbstractSubscriberUpdate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["reference", "additionalAllowedPaymentMethodConfigurations", "metaData", "emailAddress", "disallowedPaymentMethodConfigurations", "description", "shippingAddress", "language", "billingAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AbstractSubscriberUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AbstractSubscriberUpdate from a dict"""
        if obj is None:
            return None
