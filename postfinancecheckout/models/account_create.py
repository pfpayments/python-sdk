...
class AccountCreate(BaseModel):
    ...
    scope: StrictInt = Field(description="The scope that the account belongs to.")
    parent_account: Optional[StrictInt] = Field(default=None, description="The parent account responsible for administering this account.", alias="parentAccount")
    __properties: ClassVar[List[str]] = ["name", "subaccountLimit", "scope", "parentAccount"]
