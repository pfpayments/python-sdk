...
class ApplicationUserCreate(BaseModel):
    ...
    primary_account: StrictInt = Field(description="The primary account that the user belongs to.", alias="primaryAccount")
    __properties: ClassVar[List[str]] = ["requestLimit", "name", "state", "primaryAccount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApplicationUserCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplicationUserCreate from a dict"""
        if obj is None:
            return None
