...
class AuthenticatedCardData(BaseModel):
    ...
    cardholder_authentication: Optional[CardholderAuthentication] = Field(default=None, alias="cardholderAuthentication")
    __properties: ClassVar[List[str]] = ["initialRecurringTransaction", "recurringIndicator", "tokenRequestorId", "cryptogram", "cardholderAuthentication"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthenticatedCardData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthenticatedCardData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "cardholderAuthentication": CardholderAuthentication.from_dict(obj["cardholderAuthentication"]) if obj.get("cardholderAuthentication") is not None else None
        })
        return _obj
