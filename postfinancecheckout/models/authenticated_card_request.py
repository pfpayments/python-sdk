...
class AuthenticatedCardRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthenticatedCardRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthenticatedCardRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "cardData": AuthenticatedCardDataCreate.from_dict(obj["cardData"]) if obj.get("cardData") is not None else None,
