...
class BankAccountType(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["identifierName", "name", "description", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BankAccountType from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "identifierName": obj.get("identifierName"),
            "name": obj.get("name"),
