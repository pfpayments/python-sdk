...
class CardholderAuthentication(BaseModel):
    ...
    authentication_response: Optional[CardAuthenticationResponse] = Field(default=None, alias="authenticationResponse")
    ...
    version: Optional[CardAuthenticationVersion] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CardholderAuthentication from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CardholderAuthentication from a dict"""
        if obj is None:
            return None
