...
class CustomerComment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["linkedSpaceId", "pinned", "editedBy", "createdBy", "id", "editedOn", "createdOn", "version", "content", "customer"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CustomerComment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CustomerComment from a dict"""
        if obj is None:
            return None
