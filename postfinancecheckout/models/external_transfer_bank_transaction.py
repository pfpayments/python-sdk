...
class ExternalTransferBankTransaction(BaseModel):
    ...
    external_account_type: Optional[StrictStr] = Field(default=None, description="The external bank account's type.", alias="externalAccountType")
    __properties: ClassVar[List[str]] = ["externalBankName", "linkedSpaceId", "externalAccountIdentifier", "id", "bankTransaction", "version", "externalAccountType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExternalTransferBankTransaction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExternalTransferBankTransaction from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "externalBankName": obj.get("externalBankName"),
            "linkedSpaceId": obj.get("linkedSpaceId"),
            "externalAccountIdentifier": obj.get("externalAccountIdentifier"),
            "id": obj.get("id"),
