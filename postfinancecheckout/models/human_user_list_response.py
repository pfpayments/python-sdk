...
class HumanUserListResponse(BaseModel):
    """
    HumanUserListResponse
    """ # noqa: E501
    data: Optional[List[HumanUser]] = Field(default=None, description="An array containing the actual response objects.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HumanUserListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HumanUserListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [HumanUser.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
