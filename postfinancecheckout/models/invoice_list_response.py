...
class InvoiceListResponse(BaseModel):
    ...
    InvoiceListResponse
    """ # noqa: E501
    data: Optional[List[TransactionInvoice]] = Field(default=None, description="An array containing the actual response objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [TransactionInvoice.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
