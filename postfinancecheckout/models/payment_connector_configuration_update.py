...
class PaymentConnectorConfigurationUpdate(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "enabledSpaceViews", "conditions", "priority", "enabledSalesChannels", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentConnectorConfigurationUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentConnectorConfigurationUpdate from a dict"""
        if obj is None:
            return None
