...
class PaymentLinkUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["shippingAddressHandlingMode", "allowedRedirectionDomains", "language", "version", "availableFrom", "lineItems", "availableUntil", "name", "currency", "maximalNumberOfTransactions", "allowedPaymentMethodConfigurations", "appliedSpaceView", "billingAddressHandlingMode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentLinkUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentLinkUpdate from a dict"""
        if obj is None:
            return None
