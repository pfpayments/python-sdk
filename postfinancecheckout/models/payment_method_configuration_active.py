...
class PaymentMethodConfigurationActive(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["imageResourcePath", "sortOrder", "name", "description", "oneClickPaymentMode", "title", "version", "state"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentMethodConfigurationActive from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentMethodConfigurationActive from a dict"""
        if obj is None:
            return None
