...
class PaymentMethodConfigurationUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["imageResourcePath", "sortOrder", "name", "description", "oneClickPaymentMode", "title", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentMethodConfigurationUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentMethodConfigurationUpdate from a dict"""
        if obj is None:
            return None
