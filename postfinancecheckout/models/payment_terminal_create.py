...
class PaymentTerminalCreate(BaseModel):
    ...
    location_version: Optional[StrictInt] = Field(default=None, description="The physical location where the terminal is used.", alias="locationVersion")
    ...
    type: StrictInt = Field(description="The type of the payment terminal.")
    __properties: ClassVar[List[str]] = ["name", "identifier", "configurationVersion", "locationVersion", "externalId", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PaymentTerminalCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PaymentTerminalCreate from a dict"""
        if obj is None:
            return None
