...
class RefundComment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["linkedSpaceId", "pinned", "editedBy", "createdBy", "id", "editedOn", "createdOn", "version", "content", "refund"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RefundComment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RefundComment from a dict"""
        if obj is None:
            return None
