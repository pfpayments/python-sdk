...
class RestCountryState(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The state's code in ISO 3166-2 format.")
    __properties: ClassVar[List[str]] = ["code", "countryCode", "name", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RestCountryState from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RestCountryState from a dict"""
        if obj is None:
            return None
