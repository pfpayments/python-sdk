...
class RestCurrency(BaseModel):
    ...
    numeric_code: Optional[StrictInt] = Field(default=None, description="The currency's three-digit code (ISO 4217 format).", alias="numericCode")
    __properties: ClassVar[List[str]] = ["name", "fractionDigits", "currencyCode", "numericCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RestCurrency from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RestCurrency from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "fractionDigits": obj.get("fractionDigits"),
