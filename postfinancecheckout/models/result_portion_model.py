...
class ResultPortionModel(BaseModel):
    ...
    items: Optional[List[Any]] = Field(default=None, description="Items of the result portion.")
    __properties: ClassVar[List[str]] = ["offset", "limit", "totalCount", "items"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResultPortionModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResultPortionModel from a dict"""
        if obj is None:
            return None
