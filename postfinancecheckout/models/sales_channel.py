...
class SalesChannel(BaseModel):
    ...
    SalesChannel
    """ # noqa: E501
    sort_order: Optional[StrictInt] = Field(default=None, description="When listing sales channels, they can be sorted by this number.", alias="sortOrder")
    ...
    __properties: ClassVar[List[str]] = ["sortOrder", "name", "description", "id"]
