...
class SingleSignOnUserCreate(BaseModel):
    """
    ...
    provider: StrictInt = Field(description="The single sign-on provider that this user belongs to.")
    ...
    __properties: ClassVar[List[str]] = ["firstname", "timeZone", "language", "state", "lastname", "provider", "primaryAccount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SingleSignOnUserCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SingleSignOnUserCreate from a dict"""
        if obj is None:
            return None
