...
class SpaceAddressCreate(BaseModel):
    """
    SpaceAddressCreate
    """ # noqa: E501
    ...
    postcode: Optional[StrictStr] = Field(default=None, description="The postal code, also known as ZIP, postcode, etc.")
    ...
    email_address: Optional[StrictStr] = Field(default=None, description="The email address used for communication with clients.", alias="emailAddress")
    ...
    __properties: ClassVar[List[str]] = ["country", "mobilePhoneNumber", "organizationName", "city", "givenName", "postcode", "salesTaxNumber", "dependentLocality", "emailAddress", "phoneNumber", "sortingCode", "street", "familyName", "postalState", "salutation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpaceAddressCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpaceAddressCreate from a dict"""
        if obj is None:
            return None
