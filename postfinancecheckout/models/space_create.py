...
class SpaceCreate(BaseModel):
    ...
    database: Optional[StrictInt] = Field(default=None, description="The database the space is connected to and that holds the space's data.")
    account: StrictInt = Field(description="The account that the space belongs to.")
    __properties: ClassVar[List[str]] = ["requestLimit", "postalAddress", "name", "technicalContactAddresses", "timeZone", "state", "primaryCurrency", "database", "account"]
