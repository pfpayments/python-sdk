...
class SpaceSearchResponse(BaseModel):
    ...
    SpaceSearchResponse
    """ # noqa: E501
    data: Optional[List[Space]] = Field(default=None, description="An array containing the actual response objects.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpaceSearchResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpaceSearchResponse from a dict"""
        if obj is None:
            return None
