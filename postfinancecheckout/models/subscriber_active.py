...
class SubscriberActive(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["reference", "additionalAllowedPaymentMethodConfigurations", "metaData", "emailAddress", "disallowedPaymentMethodConfigurations", "description", "shippingAddress", "language", "billingAddress", "version", "state"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriberActive from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriberActive from a dict"""
        if obj is None:
            return None
