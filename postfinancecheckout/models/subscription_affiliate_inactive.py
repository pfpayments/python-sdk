...
class SubscriptionAffiliateInactive(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["metaData", "name", "language", "state", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionAffiliateInactive from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionAffiliateInactive from a dict"""
        if obj is None:
            return None
