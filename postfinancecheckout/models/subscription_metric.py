...
class SubscriptionMetric(BaseModel):
    ...
    name: Optional[Dict[str, StrictStr]] = Field(default=None, description="The localized name of the metric that is displayed to the customer.")
    ...
    type: Optional[SubscriptionMetricType] = None
    version: Optional[StrictInt] = Field(default=None, description="The version is used for optimistic locking and incremented whenever the object is updated.")
    __properties: ClassVar[List[str]] = ["linkedSpaceId", "name", "plannedPurgeDate", "description", "id", "state", "type", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionMetric from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionMetric from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "state": obj.get("state"),
            "type": SubscriptionMetricType.from_dict(obj["type"]) if obj.get("type") is not None else None,
