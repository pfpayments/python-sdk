...
class SubscriptionProductCreate(BaseModel):
    ...
    reference: Annotated[str, Field(strict=True, max_length=100)] = Field(description="The merchant's reference used to identify the product, e.g. the SKU.")
    __properties: ClassVar[List[str]] = ["sortOrder", "name", "productLocked", "state", "failedPaymentSuspensionPeriod", "allowedPaymentMethodConfigurations", "reference"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionProductCreate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionProductCreate from a dict"""
        if obj is None:
            return None
