...
class SubscriptionProductRetirement(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["linkedSpaceId", "respectTerminationPeriods", "product", "id", "createdOn", "version", "targetProduct"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionProductRetirement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionProductRetirement from a dict"""
        if obj is None:
            return None
