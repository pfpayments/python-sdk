...
class SubscriptionSearchResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[Subscription]] = Field(default=None, description="An array containing the actual response objects.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubscriptionSearchResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubscriptionSearchResponse from a dict"""
        if obj is None:
            return None
