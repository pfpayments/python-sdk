...
class AccountsService:
    ...
    def delete_accounts_id(
        ...
        _param = self._delete_accounts_id_serialize(
            id=id,
    ...
    @validate_call
    def delete_accounts_id_with_http_info(
        self,
        id: StrictInt,
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
    ...
    @validate_call
    def delete_accounts_id_without_preload_content(
        self,
        id: StrictInt,
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
    ...
    def _delete_accounts_id_serialize(
        self,
        id,
        _content_type,
        _headers,
    ...
    def get_accounts_id(
        ...
        _param = self._get_accounts_id_serialize(
            id=id,
            expand=expand,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_accounts_id_with_http_info(
        self,
        id: StrictInt,
        expand: Optional[List[StrictStr]] = None,
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_accounts_id_without_preload_content(
        self,
        id: StrictInt,
        expand: Optional[List[StrictStr]] = None,
        _content_type: Optional[StrictStr] = None,
    ...
    def _get_accounts_id_serialize(
        self,
        id,
        expand,
        _content_type,
    ...
    def get_accounts_search(
        ...
        _param = self._get_accounts_search_serialize(
            expand=expand,
            limit=limit,
            offset=offset,
            order=order,
    ...
    @validate_call
    def get_accounts_search_with_http_info(
        self,
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(le=10000, strict=True)]], Field(description="A cursor for pagination, specifies the number of objects to skip.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AccountSearchResponse]:
        """Search accounts
    ...
    @validate_call
    def get_accounts_search_without_preload_content(
        self,
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(le=10000, strict=True)]], Field(description="A cursor for pagination, specifies the number of objects to skip.")] = None,
    ...
    def _get_accounts_search_serialize(
        self,
        expand,
        limit,
        offset,
    ...
    def patch_accounts_id(
        ...
        _param = self._patch_accounts_id_serialize(
            id=id,
    ...
    @validate_call
    def patch_accounts_id_with_http_info(
        self,
        id: StrictInt,
        account_update: AccountUpdate,
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def patch_accounts_id_without_preload_content(
        self,
        id: StrictInt,
        account_update: AccountUpdate,
        expand: Optional[List[StrictStr]] = None,
    ...
    def _patch_accounts_id_serialize(
        self,
        id,
        account_update,
        expand,
    ...
    def post_accounts_id_activate(
        ...
        _param = self._post_accounts_id_activate_serialize(
            id=id,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_accounts_id_activate_with_http_info(
        self,
        id: StrictInt,
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
    ...
    @validate_call
    def post_accounts_id_activate_without_preload_content(
        self,
        id: StrictInt,
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
    ...
    def _post_accounts_id_activate_serialize(
        self,
        id,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/accounts/{id}/activate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_accounts_id_deactivate(
        self,
        id: StrictInt,
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
        ...
        _param = self._post_accounts_id_deactivate_serialize(
            id=id,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_accounts_id_deactivate_with_http_info(
        self,
        id: StrictInt,
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
    ...
    @validate_call
    def post_accounts_id_deactivate_without_preload_content(
        self,
        id: StrictInt,
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
    ...
    def _post_accounts_id_deactivate_serialize(
        self,
        id,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/accounts/{id}/deactivate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
