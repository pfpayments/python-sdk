...
class BogusExpressCheckoutService:
    ...
    @validate_call
    def post_bogus_express_checkout_on_approve(
        self,
        ...
        :type space: int
        :param bogus_express_checkout_approval_request: (required)
        :type bogus_express_checkout_approval_request: BogusExpressCheckoutApprovalRequest
        ...
        _param = self._post_bogus_express_checkout_on_approve_serialize(
            session_token=session_token,
            space=space,
            bogus_express_checkout_approval_request=bogus_express_checkout_approval_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExpressCheckoutApprovalResponse",
    ...
    @validate_call
    def post_bogus_express_checkout_on_approve_with_http_info(
        self,
        session_token: StrictStr,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        bogus_express_checkout_approval_request: BogusExpressCheckoutApprovalRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExpressCheckoutApprovalResponse]:
        """Approve express checkout wallet payment
    ...
    @validate_call
    def post_bogus_express_checkout_on_approve_without_preload_content(
        self,
        session_token: StrictStr,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        bogus_express_checkout_approval_request: BogusExpressCheckoutApprovalRequest,
    ...
    def _post_bogus_express_checkout_on_approve_serialize(
        self,
        session_token,
        space,
        ...
        if bogus_express_checkout_approval_request is not None:
            _body_params = bogus_express_checkout_approval_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/bogus-express-checkout/on-approve',
