...
class CustomersService:
    ...
    def delete_customers_bulk(
        ...
        _param = self._delete_customers_bulk_serialize(
            space=space,
    ...
    @validate_call
    def delete_customers_bulk_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        request_body: List[StrictInt],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_customers_bulk_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        request_body: List[StrictInt],
        _content_type: Optional[StrictStr] = None,
    ...
    def _delete_customers_bulk_serialize(
        self,
        space,
        request_body,
        _content_type,
    ...
    def delete_customers_id(
        ...
        _param = self._delete_customers_id_serialize(
            id=id,
            space=space,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_customers_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_customers_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    def _delete_customers_id_serialize(
        self,
        id,
        space,
        _content_type,
    ...
    def get_customers_id(
        ...
        _param = self._get_customers_id_serialize(
            id=id,
            space=space,
            expand=expand,
            _content_type=_content_type,
    ...
    @validate_call
    def get_customers_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def get_customers_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    def _get_customers_id_serialize(
        self,
        id,
        space,
        expand,
    ...
    @validate_call
    def get_customers_id_email_addresses(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        ...
        _param = self._get_customers_id_email_addresses_serialize(
            id=id,
            space=space,
            expand=expand,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CustomerEmailAddressListResponse",
            '400': "RestApiErrorResponse",
            '401': "RestApiErrorResponse",
            '403': "RestApiErrorResponse",
            '404': "RestApiErrorResponse",
    ...
    @validate_call
    def get_customers_id_email_addresses_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomerEmailAddressListResponse]:
        """List a customer's email addresses
    ...
    @validate_call
    def get_customers_id_email_addresses_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    def _get_customers_id_email_addresses_serialize(
        self,
        id,
        space,
        expand,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/customers/{id}/email-addresses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_customers_search(
        ...
        _param = self._get_customers_search_serialize(
            space=space,
            expand=expand,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def get_customers_search_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
    ...
    def _get_customers_search_serialize(
        self,
        space,
        expand,
        limit,
    ...
    @validate_call
    def patch_customers_bulk(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        customer_active: List[CustomerActive],
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[RestApiBulkOperationResult]:
        ...
        :param space: Specifies the ID of the space the operation should be executed in. (required)
        :type space: int
        :param customer_active: (required)
        :type customer_active: List[CustomerActive]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_customers_bulk_serialize(
            space=space,
    ...
    @validate_call
    def patch_customers_bulk_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        customer_active: List[CustomerActive],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def patch_customers_bulk_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        customer_active: List[CustomerActive],
        _content_type: Optional[StrictStr] = None,
    ...
    def _patch_customers_bulk_serialize(
        self,
        space,
        customer_active,
        _content_type,
    ...
    def patch_customers_id(
        ...
        :type space: int
        :param customer_active: (required)
        :type customer_active: CustomerActive
        :param expand:
        :type expand: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._patch_customers_id_serialize(
            id=id,
            space=space,
            customer_active=customer_active,
            expand=expand,
    ...
    @validate_call
    def patch_customers_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        customer_active: CustomerActive,
    ...
    @validate_call
    def patch_customers_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        customer_active: CustomerActive,
    ...
    def _patch_customers_id_serialize(
        self,
        id,
        space,
        customer_active,
    ...
    def post_customers_bulk(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        customer_create: List[CustomerCreate],
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[RestApiBulkOperationResult]:
        ...
        :type space: int
        :param customer_create: (required)
        :type customer_create: List[CustomerCreate]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_customers_bulk_serialize(
            space=space,
            customer_create=customer_create,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def post_customers_bulk_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        customer_create: List[CustomerCreate],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def post_customers_bulk_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        customer_create: List[CustomerCreate],
        _content_type: Optional[StrictStr] = None,
    ...
    def _post_customers_bulk_serialize(
        self,
        space,
        customer_create,
        _content_type,
    ...
    @validate_call
    def post_customers_id_merge_other(
        self,
        id: StrictInt,
        other: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        ...
        _param = self._post_customers_id_merge_other_serialize(
            id=id,
            other=other,
            space=space,
            expand=expand,
    ...
    @validate_call
    def post_customers_id_merge_other_with_http_info(
        self,
        id: StrictInt,
        other: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
    ...
    @validate_call
    def post_customers_id_merge_other_without_preload_content(
        self,
        id: StrictInt,
        other: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
    ...
    def _post_customers_id_merge_other_serialize(
        self,
        id,
        other,
        space,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/customers/{id}/merge/{other}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
