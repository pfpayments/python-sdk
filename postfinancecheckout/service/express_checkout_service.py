...
class ExpressCheckoutService:
    ...
    @validate_call
    def patch_express_checkout_shipping_address_change(
        self,
        ...
        :type space: int
        :param express_checkout_shipping_address_change_request: (required)
        :type express_checkout_shipping_address_change_request: ExpressCheckoutShippingAddressChangeRequest
        ...
        _param = self._patch_express_checkout_shipping_address_change_serialize(
            session_token=session_token,
            space=space,
            express_checkout_shipping_address_change_request=express_checkout_shipping_address_change_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExpressCheckoutShippingAddressChangeResponse",
    ...
    @validate_call
    def patch_express_checkout_shipping_address_change_with_http_info(
        self,
        session_token: StrictStr,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        express_checkout_shipping_address_change_request: ExpressCheckoutShippingAddressChangeRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExpressCheckoutShippingAddressChangeResponse]:
        """Change shipping address
    ...
    @validate_call
    def patch_express_checkout_shipping_address_change_without_preload_content(
        self,
        session_token: StrictStr,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        express_checkout_shipping_address_change_request: ExpressCheckoutShippingAddressChangeRequest,
    ...
    def _patch_express_checkout_shipping_address_change_serialize(
        self,
        session_token,
        space,
        express_checkout_shipping_address_change_request,
        _content_type,
        _headers,
        _host_index,
    ) -> RequestSerialized:
        ...
        if express_checkout_shipping_address_change_request is not None:
            _body_params = express_checkout_shipping_address_change_request
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/express-checkout/shipping/address-change',
    ...
    @validate_call
    def patch_express_checkout_shipping_method_change(
        self,
        session_token: StrictStr,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        ...
        :param space: Specifies the ID of the space the operation should be executed in. (required)
        :type space: int
        :param express_checkout_shipping_method_change_request: (required)
        :type express_checkout_shipping_method_change_request: ExpressCheckoutShippingMethodChangeRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_express_checkout_shipping_method_change_serialize(
            session_token=session_token,
            space=space,
            express_checkout_shipping_method_change_request=express_checkout_shipping_method_change_request,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        )
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ExpressCheckoutShippingMethodChangeResponse",
            '400': "RestApiErrorResponse",
            '401': "RestApiErrorResponse",
            '403': "RestApiErrorResponse",
            '404': "RestApiErrorResponse",
    ...
    @validate_call
    def patch_express_checkout_shipping_method_change_with_http_info(
        self,
        session_token: StrictStr,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        express_checkout_shipping_method_change_request: ExpressCheckoutShippingMethodChangeRequest,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExpressCheckoutShippingMethodChangeResponse]:
        """Change shipping method
    ...
    @validate_call
    def patch_express_checkout_shipping_method_change_without_preload_content(
        self,
        session_token: StrictStr,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        express_checkout_shipping_method_change_request: ExpressCheckoutShippingMethodChangeRequest,
    ...
    def _patch_express_checkout_shipping_method_change_serialize(
        self,
        session_token,
        space,
        express_checkout_shipping_method_change_request,
        _content_type,
        _headers,
        _host_index,
    ) -> RequestSerialized:
        ...
        # process the form parameters
        # process the body parameter
        if express_checkout_shipping_method_change_request is not None:
            _body_params = express_checkout_shipping_method_change_request
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/express-checkout/shipping/method-change',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
