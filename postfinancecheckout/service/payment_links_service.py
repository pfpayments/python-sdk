...
class PaymentLinksService:
    ...
    def delete_payment_links_id(
        ...
        _param = self._delete_payment_links_id_serialize(
            id=id,
            space=space,
    ...
    @validate_call
    def delete_payment_links_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_payment_links_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    def _delete_payment_links_id_serialize(
        self,
        id,
        space,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/payment/links/{id}',
    ...
    def get_payment_links(
        ...
        _param = self._get_payment_links_serialize(
            space=space,
            after=after,
            before=before,
            expand=expand,
    ...
    def get_payment_links_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaymentLinkListResponse]:
        """List all payment links
    ...
    @validate_call
    def get_payment_links_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        after: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately after the named object.")] = None,
        before: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately before the named object.")] = None,
    ...
    def _get_payment_links_serialize(
        self,
        space,
        after,
        before,
    ...
    def get_payment_links_id(
        ...
        _param = self._get_payment_links_id_serialize(
            id=id,
            space=space,
            expand=expand,
            _content_type=_content_type,
    ...
    @validate_call
    def get_payment_links_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def get_payment_links_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    def _get_payment_links_id_serialize(
        self,
        id,
        space,
        expand,
    ...
    def get_payment_links_search(
        ...
        _param = self._get_payment_links_search_serialize(
            space=space,
            expand=expand,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def get_payment_links_search_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaymentLinkSearchResponse]:
        """Search payment links
    ...
    @validate_call
    def get_payment_links_search_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
    ...
    def _get_payment_links_search_serialize(
        self,
        space,
        expand,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payment/links/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_payment_links_id(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        payment_link_update: PaymentLinkUpdate,
        expand: Optional[List[StrictStr]] = None,
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
        ...
        :param space: Specifies the ID of the space the operation should be executed in. (required)
        :type space: int
        :param payment_link_update: (required)
        :type payment_link_update: PaymentLinkUpdate
        :param expand:
        :type expand: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._patch_payment_links_id_serialize(
            id=id,
            space=space,
    ...
    @validate_call
    def patch_payment_links_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        payment_link_update: PaymentLinkUpdate,
    ...
    @validate_call
    def patch_payment_links_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        payment_link_update: PaymentLinkUpdate,
    ...
    def _patch_payment_links_id_serialize(
        self,
        id,
        space,
        payment_link_update,
        ...
        # process the form parameters
        # process the body parameter
        if payment_link_update is not None:
            _body_params = payment_link_update
    ...
    def post_payment_links(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        payment_link_create: PaymentLinkCreate,
        expand: Optional[List[StrictStr]] = None,
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
        ...
        :param space: Specifies the ID of the space the operation should be executed in. (required)
        :type space: int
        :param payment_link_create: (required)
        :type payment_link_create: PaymentLinkCreate
        :param expand:
        :type expand: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._post_payment_links_serialize(
            space=space,
    ...
    @validate_call
    def post_payment_links_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        payment_link_create: PaymentLinkCreate,
        expand: Optional[List[StrictStr]] = None,
    ...
    def _post_payment_links_serialize(
        self,
        space,
        payment_link_create,
        expand,
        ...
        if payment_link_create is not None:
            _body_params = payment_link_create
