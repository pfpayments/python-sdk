...
class SubscriptionMetricUsageReportsService:
    ...
    @validate_call
    def get_subscriptions_metric_usage_reports(
        self,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MetricUsageReportListResponse",
    ...
    @validate_call
    def get_subscriptions_metric_usage_reports_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        after: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately after the named object.")] = None,
        before: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately before the named object.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MetricUsageReportListResponse]:
        """List all metric usage reports
    ...
    @validate_call
    def get_subscriptions_metric_usage_reports_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        after: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately after the named object.")] = None,
        before: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately before the named object.")] = None,
    ...
    def _get_subscriptions_metric_usage_reports_serialize(
        self,
        space,
        after,
        before,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/metric-usage-reports',
    ...
    @validate_call
    def get_subscriptions_metric_usage_reports_id(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SubscriptionMetricUsageReport",
            '400': "RestApiErrorResponse",
            '401': "RestApiErrorResponse",
            '403': "RestApiErrorResponse",
            '404': "RestApiErrorResponse",
    ...
    @validate_call
    def get_subscriptions_metric_usage_reports_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SubscriptionMetricUsageReport]:
        """Retrieve a metric usage report
    ...
    @validate_call
    def get_subscriptions_metric_usage_reports_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    def _get_subscriptions_metric_usage_reports_id_serialize(
        self,
        id,
        space,
        expand,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/metric-usage-reports/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_subscriptions_metric_usage_reports_search(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MetricUsageReportSearchResponse",
            '400': "RestApiErrorResponse",
            '401': "RestApiErrorResponse",
            '403': "RestApiErrorResponse",
            '404': "RestApiErrorResponse",
    ...
    @validate_call
    def get_subscriptions_metric_usage_reports_search_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MetricUsageReportSearchResponse]:
        """Search metric usage reports
    ...
    @validate_call
    def get_subscriptions_metric_usage_reports_search_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
    ...
    def _get_subscriptions_metric_usage_reports_search_serialize(
        self,
        space,
        expand,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/metric-usage-reports/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_subscriptions_metric_usage_reports(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        subscription_metric_usage_report_create: SubscriptionMetricUsageReportCreate,
        expand: Optional[List[StrictStr]] = None,
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
        ...
        :param space: Specifies the ID of the space the operation should be executed in. (required)
        :type space: int
        :param subscription_metric_usage_report_create: (required)
        :type subscription_metric_usage_report_create: SubscriptionMetricUsageReportCreate
        :param expand:
        :type expand: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._post_subscriptions_metric_usage_reports_serialize(
            space=space,
            subscription_metric_usage_report_create=subscription_metric_usage_report_create,
            expand=expand,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "SubscriptionMetricUsageReport",
            '400': "RestApiErrorResponse",
            '401': "RestApiErrorResponse",
            '403': "RestApiErrorResponse",
            '404': "RestApiErrorResponse",
    ...
    @validate_call
    def post_subscriptions_metric_usage_reports_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        subscription_metric_usage_report_create: SubscriptionMetricUsageReportCreate,
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def post_subscriptions_metric_usage_reports_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        subscription_metric_usage_report_create: SubscriptionMetricUsageReportCreate,
        expand: Optional[List[StrictStr]] = None,
    ...
    def _post_subscriptions_metric_usage_reports_serialize(
        self,
        space,
        subscription_metric_usage_report_create,
        expand,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if subscription_metric_usage_report_create is not None:
            _body_params = subscription_metric_usage_report_create
