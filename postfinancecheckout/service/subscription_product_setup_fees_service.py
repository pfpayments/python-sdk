...
class SubscriptionProductSetupFeesService:
    ...
    @validate_call
    def delete_subscriptions_products_setup_fees_id(
        self,
        id: StrictInt,
    ...
    @validate_call
    def delete_subscriptions_products_setup_fees_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_subscriptions_products_setup_fees_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    def _delete_subscriptions_products_setup_fees_id_serialize(
        self,
        id,
        space,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/subscriptions/products/setup-fees/{id}',
    ...
    @validate_call
    def get_subscriptions_products_setup_fees(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProductSetupFeeListResponse",
            '400': "RestApiErrorResponse",
            '401': "RestApiErrorResponse",
            '403': "RestApiErrorResponse",
            '404': "RestApiErrorResponse",
    ...
    @validate_call
    def get_subscriptions_products_setup_fees_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        after: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately after the named object.")] = None,
        before: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately before the named object.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProductSetupFeeListResponse]:
        """List all setup fees
    ...
    @validate_call
    def get_subscriptions_products_setup_fees_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        after: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately after the named object.")] = None,
        before: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately before the named object.")] = None,
    ...
    def _get_subscriptions_products_setup_fees_serialize(
        self,
        space,
        after,
        before,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/products/setup-fees',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_subscriptions_products_setup_fees_id(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def get_subscriptions_products_setup_fees_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def get_subscriptions_products_setup_fees_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    def _get_subscriptions_products_setup_fees_id_serialize(
        self,
        id,
        space,
        expand,
    ...
    @validate_call
    def get_subscriptions_products_setup_fees_search(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProductSetupFeeSearchResponse",
            '400': "RestApiErrorResponse",
            '401': "RestApiErrorResponse",
            '403': "RestApiErrorResponse",
            '404': "RestApiErrorResponse",
    ...
    @validate_call
    def get_subscriptions_products_setup_fees_search_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProductSetupFeeSearchResponse]:
        """Search setup fees
    ...
    @validate_call
    def get_subscriptions_products_setup_fees_search_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
    ...
    def _get_subscriptions_products_setup_fees_search_serialize(
        self,
        space,
        expand,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/products/setup-fees/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_subscriptions_products_setup_fees_id(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        product_setup_fee_update: ProductSetupFeeUpdate,
        expand: Optional[List[StrictStr]] = None,
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
        ...
        :param space: Specifies the ID of the space the operation should be executed in. (required)
        :type space: int
        :param product_setup_fee_update: (required)
        :type product_setup_fee_update: ProductSetupFeeUpdate
        :param expand:
        :type expand: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._patch_subscriptions_products_setup_fees_id_serialize(
            id=id,
            space=space,
            product_setup_fee_update=product_setup_fee_update,
            expand=expand,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def patch_subscriptions_products_setup_fees_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        product_setup_fee_update: ProductSetupFeeUpdate,
    ...
    @validate_call
    def patch_subscriptions_products_setup_fees_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        product_setup_fee_update: ProductSetupFeeUpdate,
    ...
    def _patch_subscriptions_products_setup_fees_id_serialize(
        self,
        id,
        space,
        product_setup_fee_update,
        expand,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if product_setup_fee_update is not None:
            _body_params = product_setup_fee_update
    ...
    @validate_call
    def post_subscriptions_products_setup_fees(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        product_setup_fee_update: ProductSetupFeeUpdate,
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def post_subscriptions_products_setup_fees_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        product_setup_fee_update: ProductSetupFeeUpdate,
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def post_subscriptions_products_setup_fees_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        product_setup_fee_update: ProductSetupFeeUpdate,
        expand: Optional[List[StrictStr]] = None,
    ...
    def _post_subscriptions_products_setup_fees_serialize(
        self,
        space,
        product_setup_fee_update,
        expand,
