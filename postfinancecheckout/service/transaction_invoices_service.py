...
class TransactionInvoicesService:
    ...
    @validate_call
    def get_payment_transactions_invoices(
        self,
    ...
    @validate_call
    def get_payment_transactions_invoices_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        after: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately after the named object.")] = None,
        before: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately before the named object.")] = None,
    ...
    @validate_call
    def get_payment_transactions_invoices_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        after: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately after the named object.")] = None,
        before: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately before the named object.")] = None,
    ...
    def _get_payment_transactions_invoices_serialize(
        self,
        space,
        after,
        before,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payment/transactions/invoices',
    ...
    @validate_call
    def get_payment_transactions_invoices_id(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def get_payment_transactions_invoices_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TransactionInvoice]:
        """Retrieve a transaction invoice
    ...
    @validate_call
    def get_payment_transactions_invoices_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    def _get_payment_transactions_invoices_id_serialize(
        self,
        id,
        space,
        expand,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payment/transactions/invoices/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_payment_transactions_invoices_id_check_replacement_possible(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_payment_transactions_invoices_id_check_replacement_possible_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_payment_transactions_invoices_id_check_replacement_possible_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    def _get_payment_transactions_invoices_id_check_replacement_possible_serialize(
        self,
        id,
        space,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payment/transactions/invoices/{id}/check-replacement-possible',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_payment_transactions_invoices_id_document(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_payment_transactions_invoices_id_document_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def get_payment_transactions_invoices_id_document_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    def _get_payment_transactions_invoices_id_document_serialize(
        self,
        id,
        space,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payment/transactions/invoices/{id}/document',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_payment_transactions_invoices_search(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
    ...
    @validate_call
    def get_payment_transactions_invoices_search_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
    ...
    @validate_call
    def get_payment_transactions_invoices_search_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
    ...
    def _get_payment_transactions_invoices_search_serialize(
        self,
        space,
        expand,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payment/transactions/invoices/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_payment_transactions_invoices_id_derecognize(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def post_payment_transactions_invoices_id_derecognize_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def post_payment_transactions_invoices_id_derecognize_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    def _post_payment_transactions_invoices_id_derecognize_serialize(
        self,
        id,
        space,
        expand,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/payment/transactions/invoices/{id}/derecognize',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_payment_transactions_invoices_id_mark_paid(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def post_payment_transactions_invoices_id_mark_paid_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def post_payment_transactions_invoices_id_mark_paid_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    def _post_payment_transactions_invoices_id_mark_paid_serialize(
        self,
        id,
        space,
        expand,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/payment/transactions/invoices/{id}/mark-paid',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def post_payment_transactions_invoices_id_replace(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        ...
        :param space: Specifies the ID of the space the operation should be executed in. (required)
        :type space: int
        :param transaction_invoice_replacement: (required)
        :type transaction_invoice_replacement: TransactionInvoiceReplacement
        :param expand:
        :type expand: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._post_payment_transactions_invoices_id_replace_serialize(
            id=id,
            space=space,
            transaction_invoice_replacement=transaction_invoice_replacement,
            expand=expand,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_payment_transactions_invoices_id_replace_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        transaction_invoice_replacement: TransactionInvoiceReplacement,
    ...
    @validate_call
    def post_payment_transactions_invoices_id_replace_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        transaction_invoice_replacement: TransactionInvoiceReplacement,
    ...
    def _post_payment_transactions_invoices_id_replace_serialize(
        self,
        id,
        space,
        transaction_invoice_replacement,
        expand,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if transaction_invoice_replacement is not None:
            _body_params = transaction_invoice_replacement
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/payment/transactions/invoices/{id}/replace',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
