...
class TransactionVoidsService:
    ...
    @validate_call
    def get_payment_transactions_voids(
        self,
        ...
        _param = self._get_payment_transactions_voids_serialize(
            space=space,
            after=after,
            before=before,
            expand=expand,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TransactionVoidListResponse",
    ...
    @validate_call
    def get_payment_transactions_voids_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        after: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately after the named object.")] = None,
        before: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately before the named object.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TransactionVoidListResponse]:
        """List all transaction voids
    ...
    @validate_call
    def get_payment_transactions_voids_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        after: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately after the named object.")] = None,
        before: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately before the named object.")] = None,
    ...
    def _get_payment_transactions_voids_serialize(
        self,
        space,
        after,
        before,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payment/transactions/voids',
    ...
    @validate_call
    def get_payment_transactions_voids_id(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        ...
        _param = self._get_payment_transactions_voids_id_serialize(
            id=id,
            space=space,
            expand=expand,
            _content_type=_content_type,
    ...
    @validate_call
    def get_payment_transactions_voids_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def get_payment_transactions_voids_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    def _get_payment_transactions_voids_id_serialize(
        self,
        id,
        space,
        expand,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payment/transactions/voids/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_payment_transactions_voids_search(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
        ...
        _param = self._get_payment_transactions_voids_search_serialize(
            space=space,
            expand=expand,
            limit=limit,
            offset=offset,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TransactionVoidSearchResponse",
            '400': "RestApiErrorResponse",
            '401': "RestApiErrorResponse",
            '403': "RestApiErrorResponse",
            '404': "RestApiErrorResponse",
    ...
    @validate_call
    def get_payment_transactions_voids_search_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TransactionVoidSearchResponse]:
        """Search transaction voids
    ...
    @validate_call
    def get_payment_transactions_voids_search_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
    ...
    def _get_payment_transactions_voids_search_serialize(
        self,
        space,
        expand,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payment/transactions/voids/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
