...
class WebhookURLsService:
    ...
    @validate_call
    def delete_webhooks_urls_bulk_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        request_body: List[StrictInt],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_webhooks_urls_bulk_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        request_body: List[StrictInt],
        _content_type: Optional[StrictStr] = None,
    ...
    def _delete_webhooks_urls_bulk_serialize(
        self,
        space,
        request_body,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/webhooks/urls/bulk',
    ...
    @validate_call
    def delete_webhooks_urls_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def delete_webhooks_urls_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        _content_type: Optional[StrictStr] = None,
    ...
    def _delete_webhooks_urls_id_serialize(
        self,
        id,
        space,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/webhooks/urls/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_webhooks_urls_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        after: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately after the named object.")] = None,
        before: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately before the named object.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebhookURLListResponse]:
        """List all webhook URLs
    ...
    @validate_call
    def get_webhooks_urls_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        after: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately after the named object.")] = None,
        before: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="Set to an object's ID to retrieve the page of objects coming immediately before the named object.")] = None,
    ...
    def _get_webhooks_urls_serialize(
        self,
        space,
        after,
        before,
    ...
    @validate_call
    def get_webhooks_urls_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def get_webhooks_urls_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
    ...
    def _get_webhooks_urls_id_serialize(
        self,
        id,
        space,
        expand,
    ...
    @validate_call
    def get_webhooks_urls_search_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebhookURLSearchResponse]:
        """Search webhook URLs
    ...
    @validate_call
    def get_webhooks_urls_search_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        expand: Optional[List[StrictStr]] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="A limit on the number of objects to be returned, between 1 and 100. Default is 10.")] = None,
    ...
    def _get_webhooks_urls_search_serialize(
        self,
        space,
        expand,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/webhooks/urls/search',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_webhooks_urls_bulk(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        webhook_url_update: List[WebhookUrlUpdate],
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[RestApiBulkOperationResult]:
        ...
        :param space: Specifies the ID of the space the operation should be executed in. (required)
        :type space: int
        :param webhook_url_update: (required)
        :type webhook_url_update: List[WebhookUrlUpdate]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_webhooks_urls_bulk_serialize(
            space=space,
            webhook_url_update=webhook_url_update,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        )
    ...
    @validate_call
    def patch_webhooks_urls_bulk_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        webhook_url_update: List[WebhookUrlUpdate],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def patch_webhooks_urls_bulk_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        webhook_url_update: List[WebhookUrlUpdate],
        _content_type: Optional[StrictStr] = None,
    ...
    def _patch_webhooks_urls_bulk_serialize(
        self,
        space,
        webhook_url_update,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if webhook_url_update is not None:
            _body_params = webhook_url_update
    ...
    def patch_webhooks_urls_id(
        ...
        :type space: int
        :param webhook_url_update: (required)
        :type webhook_url_update: WebhookUrlUpdate
        :param expand:
        :type expand: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    @validate_call
    def patch_webhooks_urls_id_with_http_info(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        webhook_url_update: WebhookUrlUpdate,
    ...
    @validate_call
    def patch_webhooks_urls_id_without_preload_content(
        self,
        id: StrictInt,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        webhook_url_update: WebhookUrlUpdate,
    ...
    def _patch_webhooks_urls_id_serialize(
        self,
        id,
        space,
        webhook_url_update,
    ...
    def post_webhooks_urls(
        ...
        :param space: Specifies the ID of the space the operation should be executed in. (required)
        :type space: int
        :param webhook_url_create: (required)
        :type webhook_url_create: WebhookUrlCreate
        :param expand:
        :type expand: List[str]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
    ...
    @validate_call
    def post_webhooks_urls_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        webhook_url_create: WebhookUrlCreate,
        expand: Optional[List[StrictStr]] = None,
    ...
    @validate_call
    def post_webhooks_urls_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        webhook_url_create: WebhookUrlCreate,
        expand: Optional[List[StrictStr]] = None,
    ...
    def _post_webhooks_urls_serialize(
        self,
        space,
        webhook_url_create,
        expand,
        ...
        # process the form parameters
        # process the body parameter
        if webhook_url_create is not None:
            _body_params = webhook_url_create
    ...
    @validate_call
    def post_webhooks_urls_bulk(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        webhook_url_create: List[WebhookUrlCreate],
        _content_type: Optional[StrictStr] = None,
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[RestApiBulkOperationResult]:
        ...
        :type space: int
        :param webhook_url_create: (required)
        :type webhook_url_create: List[WebhookUrlCreate]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    @validate_call
    def post_webhooks_urls_bulk_with_http_info(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        webhook_url_create: List[WebhookUrlCreate],
        _content_type: Optional[StrictStr] = None,
    ...
    @validate_call
    def post_webhooks_urls_bulk_without_preload_content(
        self,
        space: Annotated[StrictInt, Field(description="Specifies the ID of the space the operation should be executed in.")],
        webhook_url_create: List[WebhookUrlCreate],
        _content_type: Optional[StrictStr] = None,
    ...
    def _post_webhooks_urls_bulk_serialize(
        self,
        space,
        webhook_url_create,
        _content_type,
